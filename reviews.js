...
const REVIEWS = {
  ...
  reviews: [
    ...
    { author: 'דוגמה ב׳', initial: 'ב', rating: 5, when: 'לפני חודשיים',
      text: 'טקסט לדוגמה שממתין להחלפה בביקורת אמיתית מהעמוד העסקי.' },
    { author: 'דוגמה ג׳', initial: 'ג', rating: 5, when: 'לפני 3 חודשים',
      text: 'טקסט לדוגמה שממתין להחלפה בביקורת אמיתית מהעמוד העסקי.' },
    { author: 'דוגמה ד׳', initial: 'ד', rating: 5, when: 'לפני חצי שנה',
      text: 'טקסט לדוגמה שממתין להחלפה בביקורת אמיתית מהעמוד העסקי.' }
  ]
};
